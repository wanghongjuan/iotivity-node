...
var _ = require( "lodash" ),
	...
	// Default provisioning for a device - to be used if no provisioning is found
	defaultConfiguration = {
		acl: [ {

			// I.e. everybody, a.k.a "*" (uuencoded)
			"sub": "Kg==",

			// I.e. all the default resources
			rsrc: [
				"/oic/res",
				"/oic/d",
				"/oic/p",
...
_.extend( StorageHandler.prototype, {
	...
	open: function( filename, mode ) {
		...
		try {
			...
			fs.writeSync( fd, JSON.stringify( defaultConfiguration ) );
			fs.closeSync( fd );
		} catch ( theError ) {
